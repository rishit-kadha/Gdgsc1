...
router.post('/:assetId/complete', protect, admin, assetController.completeUpload);
...
router.post('/:assetId/multipart/sign', protect, admin, assetController.signMultipartPart);

// POST   /api/assets/:assetId/multipart/complete — Complete multipart upload (admin)
router.post('/:assetId/multipart/complete', protect, admin, assetController.completeMultipartUpload);

// POST   /api/assets/:assetId/multipart/abort    — Abort multipart upload (admin)
router.post('/:assetId/multipart/abort', protect, admin, assetController.abortMultipartUpload);
